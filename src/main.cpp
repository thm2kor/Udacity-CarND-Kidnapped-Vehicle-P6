...
#ifdef DEBUG
            // delete ALL the existing debug files if existing
            std::remove("../debug/parameter-init.txt");
            std::remove("../debug/parameter-after-updateweights.txt");
            std::remove("../debug/parameter-after-resample.txt");

            std::string debug_file = std::string("../debug/parameter-init.txt");
            pf.write(debug_file);
#endif
          } else {
...
#ifdef DEBUG
          std::string debug_file = std::string("../debug/parameter-after-updateweights.txt");
          pf.write(debug_file);
#endif
          pf.resample();
#ifdef DEBUG
          debug_file = std::string("../debug/parameter-after-resample.txt");
          pf.write(debug_file);
#endif
