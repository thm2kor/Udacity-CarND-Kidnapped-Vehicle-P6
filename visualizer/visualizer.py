...
def plot_map_data():
    ...
    ax1.scatter(obs_map_x,obs_map_y, s=10, c='r', marker="s")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Compare particles ')
    parser.add_argument('--timesteps', dest='time_steps' , default=5)
